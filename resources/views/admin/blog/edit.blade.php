...
{{--                        <div class="col-md-9">--}}
{{--                            <input type="text" id="author" name="author" class="form-control {{ $errors->has('author') ? 'has-error' : '' }}"  value="{{ old('author', isset($blog) ? $blog->author : '') }}">--}}
...
{{--                        <div class="col-md-9">--}}
{{--                            <input type="text" id="category" name="category" class="form-control {{ $errors->has('category') ? 'has-error' : '' }}"  value="{{ old('category', isset($blog) ? $blog->category : '') }}">--}}
