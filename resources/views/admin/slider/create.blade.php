                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="block">
                            ...
                            <div class="block-title">
                                <h2><i class="fa fa-pencil"></i> <strong>Create</strong> Slider</h2>
                            </div>
                            <!-- END General Data Title -->

                            <!-- General Data Content -->
                            <form action="{{route('slider.store')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
