                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="block">
                            ...
                            <div class="block-title">
                                <h2><i class="fa fa-pencil"></i> <strong>Create</strong> Teacher details</h2>
                            </div>
                            <!-- END General Data Title -->

                            <!-- General Data Content -->
                            <form action="{{route('teacherdetail.store')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
...
{{--                                </div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="profession" name="profession" class="form-control {{ $errors->has('profession') ? 'has-error' : '' }}" placeholder="Enter profession..">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="product-description">About teacher</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="degree" name="degree" class="form-control {{ $errors->has('degree') ? 'has-error' : '' }}" placeholder="Enter degree..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="experience" name="experience" class="form-control {{ $errors->has('experience') ? 'has-error' : '' }}" placeholder="Enter experience..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="faculty" name="faculty" class="form-control {{ $errors->has('faculty') ? 'has-error' : '' }}" placeholder="Enter faculty..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="email" name="email" class="form-control {{ $errors->has('email') ? 'has-error' : '' }}" placeholder="Enter email..">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="phone" name="phone" class="form-control {{ $errors->has('phone') ? 'has-error' : '' }}" placeholder="Enter phone..">
