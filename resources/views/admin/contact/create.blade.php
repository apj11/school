                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="block">
                            ...
                            <form action="{{route('contact.store')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
...
{{--                                </div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <textarea id="address" name="address" class="form-control  {{ $errors->has('address') ? 'has-error' : '' }}"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="phone" name="phone" class="form-control {{ $errors->has('phone') ? 'has-error' : '' }}" >
...
{{--                                    <div class="col-md-9">--}}
{{--                                        <input type="email" id="email" name="email" class="form-control {{ $errors->has('email') ? 'has-error' : '' }}" placeholder="Enter email..">--}}
...
{{--                                </div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="email" name="email" class="form-control {{ $errors->has('email') ? 'has-error' : '' }}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="title" name="title" class="form-control {{ $errors->has('title') ? 'has-error' : '' }}" placeholder="Enter name..">
