                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="block">
                            ...
                            <div class="block-title">
                                <h2><i class="fa fa-pencil"></i> <strong>Create</strong> Notice</h2>
                            </div>
                            <!-- END General Data Title -->

                            <!-- General Data Content -->
                            <form action="{{route('notice.store')}}" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
